...
public class OccupationDaoMemory implements IOccupationDao {
	...
	public void remove( Occupation occupation) {
		// TODO Auto-generated method stub
		 ...
		 if(this.occupations == null ) throw new NullPointerException();
		 
		 else
			 this.occupations.remove(occupation.getId(), occupation);
		 	 System.out.println("Occupation removed");
	...
	public void update(Occupation occupation, String name, String description) {
		...
		System.out.println("Occupation update:   New occupation:  " + occupation.getName() +"  New description:   " + occupation.getDescription());
	}
